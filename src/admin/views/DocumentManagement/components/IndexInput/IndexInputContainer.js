...
export default function IndexInputContainer({
  ...
  // console.log(getValueOfIndex,"getValueOfIndex",typeof getValueOfIndex);
  return (
      ...
      <Col md={props.fromBulkAttachmentUploads ? 12 : 4}>
        <FormGroup>
          ...
          <Input
            ...
            name={row.id}
            value={
              typeof getValueOfIndex === "string" || typeof getValueOfIndex === "number"
                ? getValueOfIndex
                : getValueOfIndex(listValues, row.id)
            }
            disabled={typeof getValueOfIndex === "string" || typeof getValueOfIndex === "number" ? disabled : enabled}
