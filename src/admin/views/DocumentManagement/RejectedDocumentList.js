...
import { getRejectedDocuments } from "./api/document";
import CustomLoadingOverlay from "./CustomOverlayLoading";

const RejectedDocumentList = (props) => {
  ...
  return (
    <CustomLoadingOverlay isLoading={loading}>
      <DocumentListTable
        title="Rejected Document List"
        fromRejectedListTable
