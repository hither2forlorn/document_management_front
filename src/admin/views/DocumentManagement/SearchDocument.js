...
class SearchDocument extends React.Component {
  ...
  componentDidMount() {
    this.setState({
      branches: this.props.allFields.branches,
      departments: this.props.allFields.departments,
    });
    ...
    localStorage.setItem("parentDocTypes", JSON.stringify(tempParentDocTypes));
    ...
    const parentDocTypesFromStorage = localStorage.getItem("parentDocTypes");
    if (parentDocTypesFromStorage) {
      this.setState({ docTypes: JSON.parse(parentDocTypesFromStorage) });
    }
  }
      ...
      <Card className="shadow">
        ...
        <CardBody className="pt-3">
          <Form onSubmit={(e) => e.preventDefault()} ref={this.myRef}>
            <FormGroup>
              <Label className="mt-1">{this.props.AttachmentBata ? "Attachment Type" : "Document Category"} </Label>
              <select
              ...
              >
                ...
                {getOptions(this.state.docTypes.length > 0 ? this.state.docTypes : docTypes)}
              </select>
              ...
              >
                <Button style={{ marginRight: " 15px", width: "100%" }} onClick={this.props.handleAccountSearch}>
                  Search
                </Button>
                <Button
                  style={{
            ...
            <FormGroup>
              ...
              >
                <option value="">-- NONE --</option>
                {getOptions(this.props.allFields.departments || this.state.departments)}
              </select>
            </FormGroup>
            ...
            <FormGroup>
              ...
              >
                <option value="">-- NONE --</option>
                {getOptions(this.props.allFields.branches || this.state.branches)}
              </select>
            </FormGroup>
            ...
            <FormGroup>
              ...
              >
                <option value="">-- NONE --</option>
                {getOptions(this.props.allFields.statuses || this.state.statuses)}
              </select>
            </FormGroup>
